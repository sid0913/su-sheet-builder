"""
Seam-free DETECTOR -> SAM segmentation of the 2026 drone flight.
...
OUT = os.path.join(SP, "sam_architecture_2026_detector.gpkg")
RAW_OUT = os.path.join(SP, "sam_architecture_2026_detector_raw.gpkg")
